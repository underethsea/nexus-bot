...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    console.log("eth capacity ", capacity.capacity[0].amount / 1e18);
    console.log("dai capacity ", capacity.capacity[1].amount / 1e18);
    console.log("nxm capacity ", capacity.capacity[2].amount / 1e18);
    const noCapacity =
